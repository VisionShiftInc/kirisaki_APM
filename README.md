...
```bash
apm install VisionShiftInc/kirisaki_APM/common
```
...
apm install VisionShiftInc/kirisaki_APM/common/.apm/skills/devcontainer-aware-command-execution
# Self-contained primitives just need the .md file:
apm install VisionShiftInc/kirisaki_APM/common/.apm/instructions/filesystem-boundaries.instructions.md
```
